...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: `The teeth are not designed for the repeated shear force of biting hard nail material. The main clinical review of onychophagia lists the oral and dental complications as gingival injury (with swelling and abscess), increased incisor wear, malocclusion of the teeth, apical root resorption, and rotation of the incisors (Lee & Lipner, 2022).\n\nPain and dysfunction of the temporomandibular joint (TMJ) have also been reported in chronic nail biters. The same review recommends that recognising these dental and jaw signs should prompt a referral to a dentist for further evaluation.`,
...
BLOG_POSTS.push({
  ...
  sections: [
    ...
    },
    {
      ...
      body: `The most consistently discussed personality correlation with nail biting is perfectionism. In a 2015 experimental study of 24 people with body-focused repetitive behaviours — including nail biting — and 23 controls (Roberts et al., Journal of Behavior Therapy and Experimental Psychiatry), the BFRB group reported stronger urges than controls overall, and reported their strongest urges under boredom and frustration rather than relaxation. The researchers connected that to the group's significantly higher scores on maladaptive planning style — high standards paired with an unwillingness to relax. The mechanism is frustration-based: perfectionism creates a persistent gap between how things are and how they should be, and that gap generates a tension state that nail biting relieves effectively in the short term.\n\nThe perfectionism-nail biting connection is sufficiently strong that it has treatment implications. People whose biting is perfection-driven often respond better to Acceptance and Commitment Therapy (ACT) — which targets frustration tolerance — than to pure behavioural HRT approaches. If your biting peaks during focused work, when projects stall, or when things fall short of your standard, perfectionism is likely a primary driver.`,
      html: `<p><strong>Sources:</strong></p><ul><li><a href="https://pubmed.ncbi.nlm.nih.gov/25460266/" target="_blank" rel="noopener noreferrer">Roberts S, O'Connor K, Aardema F, Bélanger C. The impact of emotions on body-focused repetitive behaviors: evidence from a non-treatment-seeking sample. J Behav Ther Exp Psychiatry. 2015;46:189–197.</a></li></ul>`,
    },
    {
...
BLOG_POSTS.push({
  ...
  sections: [
    ...
    },
    {
      ...
      body: `The clearest case of permanent damage is significant, repeated trauma to the nail matrix itself — the tissue that produces the nail. This is more common with very severe, long-term biting that extends beyond the nail plate into the matrix area, or with co-occurring compulsive picking at the nail bed.\n\nSevere, chronic damage to that specific tissue can, in some cases, result in a nail that grows back permanently altered in shape or texture rather than returning to its original baseline, since matrix tissue has more limited regenerative capacity than the nail plate itself once significantly scarred.\n\nThis is the exception rather than the typical outcome, and is more associated with the most severe end of the nail biting severity spectrum than with typical chronic biting.`,
    },
    {
      heading: `Is it too late to stop?`,
      body: `No. For the substantial majority of nail biters, the physical damage — however alarming it looks at its worst — is not a permanent state. Stopping at any point, even after many years, allows for essentially full nail and cuticle recovery over a period of months.\n\nThis is worth knowing both as reassurance (the damage you're looking at right now is very likely reversible) and as motivation (the sooner biting stops, the less cumulative matrix trauma accumulates, keeping you further from the less common but real threshold where damage does become harder to fully reverse).`,
    },
    MEDICAL_DISCLAIMER_SECTION,
  ],
});
