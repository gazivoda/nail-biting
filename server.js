...
if (!existsSync(distPath)) {
  ...
  const BLOG_SECTIONS_DATA = {
    ...
    'stop-biting-vs-mavala-stop': [
      ...
      { heading: 'Side-by-side comparison', body: `Here's how the two products compare on the dimensions that matter most:`, list: ['Mechanism — Stop Biting: AI webcam detection fires an alert before the bite. Mavala Stop: bitter taste deters on contact.', 'Works away from screen — Stop Biting: No (screen-time only). Mavala Stop: Yes (works 24/7).', 'Effective for established habits — Stop Biting: Strong (awareness mechanism directly addresses automaticity). Mavala Stop: Variable (habituation risk within 2–3 weeks).', 'Price — Stop Biting: €2.99/month or €29/year with 7-day free trial. Mavala Stop: ~€10–€12 one-time purchase.', 'Privacy — Stop Biting: 100% on-device, no data transmitted. Mavala Stop: physical product, no data.', 'Addresses root trigger — Stop Biting: Yes (builds awareness). Mavala Stop: No (deterrent only).'] },
